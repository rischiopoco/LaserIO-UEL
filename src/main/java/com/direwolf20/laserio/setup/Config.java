...
public class Config {
    ...
    static {
        ...
        MAX_NODES_DISTANCE = COMMON_BUILDER.comment("Maximum distance between 2 nodes")
        ...
        MIN_TICKS_ITEM = COMMON_BUILDER.comment("Minimum ticks/operation, the first element is with no Logistic Overclockers, the last one is with all 4")
        ...
        MIN_TICKS_FLUID = COMMON_BUILDER.comment("Minimum ticks/operation, the first element is with no Logistic Overclockers, the last one is with all 4")
        ...
        MIN_TICKS_CHEMICAL = COMMON_BUILDER.comment("Minimum ticks/operation, the first element is with no Logistic Overclockers, the last one is with all 4")
